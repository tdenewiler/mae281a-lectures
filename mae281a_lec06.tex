...
Consider the nominal case where $\lambda=\lambda_0$ and the nominal system $\dot{x}=f(t,x,\lambda_0)$. Assuming that there exists a unique solution over the range $[t_0,t_1]$ this leads to
\begin{align*}
